...
class Index extends Component {
  ...
  recommendFilterShow = () => {
    ...
    let overlayRef = null;
    let overlayView = (
      <Overlay.View modal={true} overlayOpacity={0.3} ref={(v) => (overlayRef = v)}>
        {/* 筛选组件 */}
        <FilterPanel params={others} onClose={() => overlayRef.close()} onSubmitFilter={this.handleSubmitFilter} />
      </Overlay.View>
    );
